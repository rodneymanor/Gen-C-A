...
import { getScriptsService, ScriptsServiceError } from '../../src/services/scripts/scripts-service.js';

export async function getScriptsRequestContext(req: VercelRequest, res: VercelResponse) {
...
export function sendScriptsError(
  res: VercelResponse,
  error: unknown,

...
declare class FeatureGates {
    ...
    static initialize: (clientOptions: import("./types").ClientOptions, identifiers: import("./types").Identifiers, customAttributes?: import("./types").CustomAttributes) => Promise<void>;
    static initializeWithProvider: (clientOptions: import("./types").BaseClientOptions, provider: import("./types").Provider, identifiers: import("./types").Identifiers, customAttributes?: import("./types").CustomAttributes) => Promise<void>;
    static initializeFromValues: (clientOptions: import("./types").FromValuesClientOptions, identifiers: import("./types").Identifiers, customAttributes?: import("./types").CustomAttributes, initializeValues?: Record<string, unknown>) => Promise<void>;
    ...
    static isCurrentUser: (identifiers: import("./types").Identifiers, customAttributes?: import("./types").CustomAttributes) => boolean;
    ...
    static updateUser: (fetchOptions: import("./fetcher").FetcherOptions, identifiers: import("./types").Identifiers, customAttributes?: import("./types").CustomAttributes) => Promise<void>;
    static updateUserWithProvider: (identifiers: import("./types").Identifiers, customAttributes?: import("./types").CustomAttributes) => Promise<void>;
    static updateUserWithValues: (identifiers: import("./types").Identifiers, customAttributes?: import("./types").CustomAttributes, initializeValues?: Record<string, unknown>) => Promise<void>;

...
var _functionWithCondition = require("../function-with-condition");
...
function conditionalHooksFactory(condition, newHook, oldHook) {
  ...
  return (0, _functionWithCondition.functionWithCondition)(function () {
    ...
    if (globalCacheGateCache === null) {
      globalCacheGateCache = (0, _platformFeatureFlags.fg)('platform_editor_global_conditional_factory_cache');
    }

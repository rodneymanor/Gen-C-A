...
var JSXExpressionLinter = /*#__PURE__*/function () {
   ...
   */
  return (0, _createClass2.default)(JSXExpressionLinter, [{
    key: "getDeclaratorString",
    value: function getDeclaratorString(node) {
      var scope = (0, _contextCompat.getScope)(this.context, node);
    ...
    value: function analyzeIdentifier(sourceIdentifier) {
      var _getIdentifierInParen,
        ...
        _this = this;
      var scope = (0, _contextCompat.getScope)(this.context, sourceIdentifier);
    ...
    value: function potentiallyHasLocalVariable(node) {
      ...
      var isImportedVariable = function isImportedVariable(identifier) {
        return !!(0, _getImportNodeBySource.getModuleOfIdentifier)((0, _contextCompat.getSourceCode)(_this2.context), identifier);
      };

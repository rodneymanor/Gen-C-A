...
exports.isXcss = exports.isStyledComponents = exports.isStyled = exports.isKeyframes = exports.isImportedFrom = exports.isEmotion = exports.isCxFunction = exports.isCssMap = exports.isCss = exports.isCompiled = exports.isAtlasKitCSS = exports.hasStyleObjectArguments = exports.getImportSources = exports.DEFAULT_IMPORT_SOURCES = exports.CSS_IN_JS_IMPORTS = void 0;
var _eslintCodemodUtils = require("eslint-codemod-utils");
var _findIdentifierNode = require("./find-identifier-node");
...
var isSupportedImportWrapper = function isSupportedImportWrapper(functionName) {
  ...
  var isSupportedImport = function isSupportedImport(nodeToCheck, referencesInScope, importSources) {
    var identifierNode = (0, _findIdentifierNode.findIdentifierNode)(nodeToCheck);
...
var hasStyleObjectArguments = exports.hasStyleObjectArguments = function hasStyleObjectArguments(node, references, importSources) {
  return [isCss, isCssMap, isKeyframes, isStyled, isXcss].some(function (checker) {
    if (checker === isStyled) {
       ...
       */
      var shouldIgnore = (0, _eslintCodemodUtils.isNodeOfType)(node, 'Identifier') && (((_node$parent = node.parent) === null || _node$parent === void 0 || (_node$parent = _node$parent.parent) === null || _node$parent === void 0 ? void 0 : _node$parent.type) === 'CallExpression' || ((_node$parent2 = node.parent) === null || _node$parent2 === void 0 || (_node$parent2 = _node$parent2.parent) === null || _node$parent2 === void 0 ? void 0 : _node$parent2.type) === 'TaggedTemplateExpression');
      if (shouldIgnore) {
        return false;
      }
    }
...
var isAtlasKitCSS = exports.isAtlasKitCSS = isImportedFrom('@atlaskit/css', false);
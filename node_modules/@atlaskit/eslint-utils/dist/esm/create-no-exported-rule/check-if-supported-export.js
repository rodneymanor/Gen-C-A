...
var _checkIfSupportedExport = function checkIfSupportedExport(context, node, importSources) {
  var _reference$resolved$r, _reference$resolved;
  ...
  var identifiers = (_reference$resolved$r = reference === null || reference === void 0 || (_reference$resolved = reference.resolved) === null || _reference$resolved === void 0 || (_reference$resolved = _reference$resolved.references) === null || _reference$resolved === void 0 ? void 0 : _reference$resolved.map(function (_ref2) {
    var identifier = _ref2.identifier;
    return identifier;
  })) !== null && _reference$resolved$r !== void 0 ? _reference$resolved$r : [];
  ...
  var uniqueVariableDeclarations = identifiers.filter(function (identifier) {
    var i = identifier;

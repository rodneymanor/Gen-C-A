...
function createDroppableRegistry() {
  ...
  var register = function register2(entry) {
    var _updateListener;
...
function getActualDestination(_ref) {
  var start2 = _ref.start, target = _ref.target;
  if (target === null) {
    return null;
  }
  var isSameList = start2.droppableId === target.droppableId;
  var isMovingForward = target.index > start2.index;
...
var moveHandlers = {
  mainAxis: {
    prev: function prev(event, _ref) {
      ...
      var nextLocation = _objectSpread3(_objectSpread3({}, targetLocation), {}, {
...
var keyHandlers = {
  vertical: _objectSpread3(_objectSpread3({}, commonKeyHandlers), {}, {
  ...
  horizontal: _objectSpread3(_objectSpread3({}, commonKeyHandlers), {}, {
...
function useKeyboardControls(_ref5) {
  ...
  var startKeyboardDrag = (0, import_react8.useCallback)(function(_ref6) {
    ...
    var cleanupFn = (0, import_bind_event_listener2.bindAll)(window, [{
      type: "keydown",
...
var createAutoScroller = function createAutoScroller2() {
  ...
  var start2 = function start3(_ref) {
...
function start() {
  cleanup();
  unbindEvents = (0, import_bind_event_listener3.bindAll)(
    window,
    [{
      type: "dragover",
      listener: acceptDrop
...
function DragDropContext2(_ref) {
  ...
  }, [droppableRegistry, lifecycle, onDragUpdate2, schedule2]);
  var startDrag2 = (0, import_react13.useCallback)(function(_ref4) {
    ...
    var droppableId = start2.source.droppableId;
    var droppable = droppableRegistry.getEntry({
      droppableId
    });
    ...
    dragStateRef.current = {
      ...
      draggableId,
      type,
      prevDestination: start2.source,
      sourceLocation: start2.source,
      targetLocation: start2.source,
      draggableInitialOffsetInSourceDroppable: getOffset({
        element: sourceElement,
        mode: droppable.mode
      })
    };
    onBeforeDragStart === null || onBeforeDragStart === void 0 || onBeforeDragStart(start2);
    ...
    schedule2(function() {
      ...
      var _getProvided2 = getProvided("onDragStart", start3), provided = _getProvided2.provided, getMessage = _getProvided2.getMessage;
      onDragStart2 === null || onDragStart2 === void 0 || onDragStart2(start3, provided);
      announce(getMessage());
      schedule2(function() {
        var droppableId2 = start3.source.droppableId;
  ...
  }, [droppableRegistry, getClosestEnabledDraggableLocation, lifecycle, onBeforeCapture, onBeforeDragStart, onDragStart2, schedule2, updateDrag]);
  ...
  }, [contextId, flush, keyboardCleanupManager, lifecycle, onDragEnd2, updateDrag]);
...
function getDraggingStyle(_ref) {
  ...
  return _objectSpread4(_objectSpread4({}, baseDraggingStyle), {}, {
...
function updateKeyboardPreview(state, _ref7) {
  ...
  return _objectSpread6(_objectSpread6({}, state), {}, {
    previewOffset
  });
}
function startDrag(state, _ref8) {
  var start2 = _ref8.start, previewOffset = _ref8.previewOffset;
  rbdInvariant(state.type === "idle", "The draggable is idle.");
  var draggingOver = start2.source.droppableId;
  var nextState = {
    type: "dragging",
    draggingOver,
    location: null,
    start: start2.source,
    draggableId: start2.draggableId,
    mode: start2.mode,
    previewOffset
  };
  return nextState;
...
function reducer(state, action) {
  if (action.type === "START_POINTER_DRAG") {
    return startDrag(state, _objectSpread6(_objectSpread6({}, action.payload), {}, {
      previewOffset: {
        x: 0,
        y: 0
      }
  ...
  if (action.type === "UPDATE_DRAG") {
    ...
    var nextState = _objectSpread6(_objectSpread6({}, state), {}, {
      draggingOver
    });
    return nextState;
  }
  if (action.type === "UPDATE_POINTER_PREVIEW") {
    ...
    var _nextState = _objectSpread6(_objectSpread6({}, state), {}, {
      previewOffset: {
...
function Draggable(_ref) {
  ...
  (0, import_react19.useEffect)(function() {
    ...
    return (0, import_bind_event_listener4.bindAll)(dragHandle, [{
      type: "keydown",
      listener: function listener(event) {
        if (event.key === " ") {
          if (event.defaultPrevented) {
  ...
  (0, import_react19.useEffect)(function() {
    if (shouldRenderCloneWhileDragging) {
      return monitorForLifecycle({
        onPendingDragStart: function onPendingDragStart(_ref3) {
          ...
          if (data.draggableId !== start2.draggableId) {
            return;
          }
          dispatch({
            type: "START_HIDING",
    ...
    return combine(monitorForLifecycle({
      onPendingDragStart: function onPendingDragStart(_ref5) {
        var start2 = _ref5.start, droppable = _ref5.droppable;
        if (data.draggableId !== start2.draggableId) {
          return;
        }
        if (start2.mode === "FLUID") {
          return dispatch({
...
function DraggableClone(_ref2) {
  ...
  (0, import_react20.useEffect)(function() {
    return combine(monitorForLifecycle({
      onPendingDragStart: function onPendingDragStart(_ref3) {
        var start2 = _ref3.start, droppable = _ref3.droppable;
        if (droppableId !== start2.source.droppableId) {
          return;
        }
        if (start2.mode === "FLUID") {
          return dispatch({
...
function reducer2(state, action) {
  if (action.type === "DRAG_START") {
    var _action$payload = action.payload, droppableId = _action$payload.droppableId, start2 = _action$payload.start;
    var draggableId = start2.draggableId, source = start2.source;
    ...
    return _objectSpread7(_objectSpread7({}, state), {}, {
      isDraggingOver,
    ...
    value: function render() {
      ...
      return import_react27.default.createElement(Draggable, {
        ...
        return import_react27.default.createElement(RankableTableBodyRow, _extends({}, restRowProps, provided.dragHandleProps, provided.draggableProps, {
          ...
          style: _objectSpread8(_objectSpread8({}, provided.draggableProps.style), inlineStyles),
...
//# sourceMappingURL=body-D5BFSA3Q.js.map

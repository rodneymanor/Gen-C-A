...
var React24, import_react28, coreSizeMedium, coreSizeSmall, utilSizes, baseSizeMap, paddingMap, Icon, icon_new_default;
var init_icon_new = __esm({
  "node_modules/@atlaskit/icon/dist/esm/components/icon-new.js"() {
    ...
    Icon = (0, import_react28.memo)(function Icon2(props) {
      var _props$type;
      ...
      if (FallbackIcon && !fg("platform-visual-refresh-icons")) {
        return React24.createElement(FallbackIcon, {
...
init_esm();
var _React$useId;
var react18UseId = (_React$useId = import_react3.default.useId) !== null && _React$useId !== void 0 ? _React$useId : void 0;
function useId() {
...
var IdProvider = (0, import_react3.forwardRef)(function(_ref, ref) {
  ...
  return import_react3.default.createElement(import_react3.default.Fragment, null, typeof children === "function" ? children({
    id
  }) : children);
});
function useIdSeed() {
...
var SurfaceContext = (0, import_react4.createContext)("elevation.surface");
var useSurface = function useSurface2() {
  return (0, import_react4.useContext)(SurfaceContext);
};
...
var Flex = (0, import_react8.memo)((0, import_react8.forwardRef)(function(_ref, ref) {
  var _ref$as = _ref.as, Component2 = _ref$as === void 0 ? "div" : _ref$as, role = _ref.role, alignItems = _ref.alignItems, justifyContent = _ref.justifyContent, gap = _ref.gap, columnGap = _ref.columnGap, rowGap = _ref.rowGap, children = _ref.children, testId = _ref.testId, direction = _ref.direction, wrap = _ref.wrap, xcss = _ref.xcss, ariaAttributes = _objectWithoutProperties(_ref, _excluded);
  return React8.createElement(Component2, _extends({}, ariaAttributes, {
    role,
...
// node_modules/@atlaskit/primitives/dist/esm/compiled/components/inline.js
var _excluded2 = ["as", "alignInline", "alignBlock", "shouldWrap", "spread", "grow", "space", "rowSpace", "separator", "xcss", "testId", "role", "children"];
var styles2 = {
...
var Inline = (0, import_react9.memo)((0, import_react9.forwardRef)(function(_ref2, ref) {
  ...
  var separatorComponent = typeof separator === "string" ? React9.createElement(Separator, null, separator) : separator;
  var children = separatorComponent ? import_react9.Children.toArray(rawChildren).filter(Boolean).map(function(child, index) {
    return React9.createElement(import_react9.Fragment, {
      key: index
    }, separator && index > 0 ? separatorComponent : null, child);
  }) : rawChildren;
  return React9.createElement(flex_default, _extends({}, ariaAttributes, {
    as,
    role,
    alignItems,
...
var HasTextAncestorContext = (0, import_react10.createContext)(false);
var useHasTextAncestor = function useHasTextAncestor2() {
  return (0, import_react10.useContext)(HasTextAncestorContext);
};
...
var Text = (0, import_react11.forwardRef)(function(_ref, ref) {
  var _ref$as = _ref.as, Component2 = _ref$as === void 0 ? "span" : _ref$as, colorProp = _ref.color, align = _ref.align, testId = _ref.testId, id = _ref.id, size = _ref.size, weight = _ref.weight, maxLines = _ref.maxLines, xcss = _ref.xcss, children = _ref.children;
  invariant(asAllowlist.includes(Component2), '@atlaskit/primitives: Text received an invalid "as" value of "'.concat(Component2, '"'));
  var hasTextAncestor = useHasTextAncestor();
  var color = useColor(colorProp, hasTextAncestor);
  if (!size && !hasTextAncestor) {
    size = "medium";
  }
  var component = React10.createElement(Component2, {
    id,
    className: ax([styles3.root, size && fontSizeMap[size], color && textColorMap[color], maxLines && styles3.truncation, maxLines === 1 && styles3.breakAll, align && styles3["textAlign.".concat(align)], weight && fontWeightMap[weight], Component2 === "em" && styles3["as.em"], Component2 === "strong" && styles3["as.strong"], xcss]),
    style: {
  ...
  return React10.createElement(HasTextAncestorProvider, {
    value: true
  }, component);
});
...
var esm_default = (0, import_react12.createContext)(null);
...
var _excluded3 = ["as", "children", "isInset", "testId", "style", "xcss"];
...
var Focusable = (0, import_react13.forwardRef)(function(_ref, ref) {
  var _ref$as = _ref.as, Component2 = _ref$as === void 0 ? "button" : _ref$as, children = _ref.children, isInset = _ref.isInset, testId = _ref.testId, style = _ref.style, xcss = _ref.xcss, htmlAttributes = _objectWithoutProperties(_ref, _excluded3);
  var _spreadClass = htmlAttributes.className, safeHtmlAttributes = _objectWithoutProperties(htmlAttributes, _excluded22);
  return React11.createElement(Component2, _extends({}, safeHtmlAttributes, {
...
// node_modules/@atlaskit/primitives/dist/esm/compiled/components/pressable.js
var _excluded4 = ["children", "isDisabled", "type", "onClick", "interactionName", "componentName", "analyticsContext", "style", "testId", "xcss", "tabIndex"];
var _excluded23 = ["className"];
var styles4 = {
  root: "_19itglyw _vchhusvi _r06hglyw _80omtlke",
  disabled: "_80om13gf"
};
var Pressable = (0, import_react14.forwardRef)(function(_ref, ref) {
  ...
  var interactionContext = (0, import_react14.useContext)(esm_default);
  var handleClick = (0, import_react14.useCallback)(function(e, analyticsEvent) {
...
var _excluded5 = ["as", "children", "backgroundColor", "padding", "paddingBlock", "paddingBlockStart", "paddingBlockEnd", "paddingInline", "paddingInlineStart", "paddingInlineEnd", "style", "testId", "xcss"];
...
var Box = (0, import_react16.forwardRef)(
  function(_ref, ref) {
    ...
    if (backgroundColor) {
      return React13.createElement(SurfaceContext.Provider, {
...
var _excluded6 = ["as", "alignInline", "alignBlock", "spread", "grow", "space", "children", "testId", "xcss", "role"];
var styles5 = {
  hug: "_16jlidpf",
  fill: "_1bsb1osq _16jlkb7n"
};
var Stack = (0, import_react17.memo)((0, import_react17.forwardRef)(function(_ref, ref) {
  ...
  return React14.createElement(flex_default, _extends({}, ariaAttributes, {
    as,
    role,
    gap: space,
    direction: "column",
...
var Grid = (0, import_react18.memo)((0, import_react18.forwardRef)(function(_ref, ref) {
  ...
  var Component2 = as || "div";
  return React15.createElement(Component2, {
    id,
    role,
...
var Bleed = import_react19.default.memo(function(_ref) {
...
var MetricText = (0, import_react20.forwardRef)(function(_ref, ref) {
  var _ref$as = _ref.as, Component2 = _ref$as === void 0 ? "span" : _ref$as, align = _ref.align, testId = _ref.testId, id = _ref.id, size = _ref.size, children = _ref.children;
  invariant(asAllowlist2.includes(Component2), '@atlaskit/primitives: MetricText received an invalid "as" value of "'.concat(Component2, '"'));
  var component = React17.createElement(Component2, {
    ref,
    "data-testid": testId,
    id,
...
var RouterLinkProviderContext = (0, import_react21.createContext)({});
...
var ColorModeContext = (0, import_react22.createContext)(void 0);
var SetColorModeContext = (0, import_react22.createContext)(void 0);
var ThemeContext = (0, import_react22.createContext)(void 0);
var SetThemeContext = (0, import_react22.createContext)(void 0);
...
// node_modules/@atlaskit/app-provider/dist/esm/app-provider.js
var InsideAppProviderContext = (0, import_react23.createContext)(false);
...
var useRouterLink = function useRouterLink2() {
  var _useContext = (0, import_react24.useContext)(RouterLinkProviderContext), routerLinkComponent = _useContext.routerLinkComponent;
...
// node_modules/@atlaskit/primitives/dist/esm/compiled/components/anchor.js
var _excluded7 = ["href", "children", "onClick", "interactionName", "componentName", "analyticsContext", "aria-label", "aria-labelledby", "style", "target", "testId", "xcss", "newWindowLabel"];
...
var AnchorNoRef = function AnchorNoRef2(_ref, ref) {
  ...
  var interactionContext = (0, import_react25.useContext)(esm_default);
  var handleClick = (0, import_react25.useCallback)(function(e, analyticsEvent) {
    interactionContext && interactionContext.tracePress(interactionName, e.timeStamp);
    providedOnClick(e, analyticsEvent);
  }, [providedOnClick, interactionContext, interactionName]);
  ...
  var Component2 = isRouterLink ? RouterLink : "a";
  return React21.createElement(
    ...
    children,
    target === "_blank" && (children && !ariaLabel && !ariaLabelledBy || ariaLabelledBy) && React21.createElement(visually_hidden_default, {
      id: opensNewWindowLabelId
    }, ", ".concat(newWindowLabel))
  );
};
var Anchor = (0, import_react25.forwardRef)(AnchorNoRef);
...
//# sourceMappingURL=chunk-2ARPU2R5.js.map

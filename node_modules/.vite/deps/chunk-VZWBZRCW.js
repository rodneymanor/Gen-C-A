...
import "/Users/rmanor/Documents/Development-Local/Gen C A/node_modules/@atlaskit/button/dist/esm/new-button/variants/shared/button-base.compiled.css";
init_esm();
...
import "/Users/rmanor/Documents/Development-Local/Gen C A/node_modules/@atlaskit/button/dist/esm/new-button/variants/shared/content.compiled.css";
var styles2 = {
...
var IconRenderer = function IconRenderer2(_ref) {
  ...
  return import_react5.default.createElement(import_react5.default.Fragment, null, isRenderProp ? Icon(iconProps) : import_react5.default.createElement(Icon, iconProps));
};
...
var IconButton = import_react7.default.memo(import_react7.default.forwardRef(function Button3(_ref, ref) {
  ...
  if (isTooltipDisabled) {
    return import_react7.default.createElement(button_base_default, _extends({}, saferRest, {
      ref,
      appearance,
      autoFocus,
      isDisabled,
      ...
      type,
      interactionName
    }), import_react7.default.createElement(content_default, {
      type: "icon",
      isLoading
    }, import_react7.default.createElement(icon_renderer_default, {
      icon
    }), import_react7.default.createElement(visually_hidden_default, null, label)));
  }
  return import_react7.default.createElement(tooltip_default, {
...
var LinkButtonBase = function LinkButtonBase2(_ref, ref) {
  ...
  var localRef = (0, import_react8.useRef)(null);
  useAutoFocus(localRef, autoFocus);
  var combinedRef = mergeRefs([localRef, ref]);
  return React7.createElement(anchor_default, _extends({
    analyticsContext,
    ref: combinedRef,
  ...
  }), iconBefore && React7.createElement(content_default, {
    type: "icon",
    position: "before",
    isLoading: false
  }, React7.createElement(icon_renderer_default, {
    icon: iconBefore
  })), children && React7.createElement(content_default, {
    isLoading: false
  }, children), iconAfter && React7.createElement(content_default, {
    type: "icon",
    position: "after",
    isLoading: false
  }, React7.createElement(icon_renderer_default, {
...
var LinkButton = (0, import_react8.forwardRef)(LinkButtonBase);
...
import "/Users/rmanor/Documents/Development-Local/Gen C A/node_modules/@atlaskit/button/dist/esm/new-button/variants/icon/link.compiled.css";
init_esm();
...
init_runtime();
init_esm();
import "/Users/rmanor/Documents/Development-Local/Gen C A/node_modules/@atlaskit/button/dist/esm/new-button/containers/split-button/split-button.compiled.css";
...
//# sourceMappingURL=chunk-VZWBZRCW.js.map

import {
  es2015_default
} from "./chunk-DJ3FMVKA.js";
import {
  require_cross
} from "./chunk-TXOBVSBR.js";
import {
  require_radio
} from "./chunk-MATO44DH.js";
import {
  require_chevron_down,
  svg_default
} from "./chunk-6MLCQYIT.js";
...
} from "./chunk-TUWFI74F.js";
import {
  require_react_dom
} from "./chunk-G52XTN3B.js";
import {
  spinner_default
} from "./chunk-KJ57VQFD.js";
import {
  base_new_exports,
  init_base_new
} from "./chunk-HLN4WRPD.js";
import {
  IdProvider,
  cx,
  inline_default,
...
var LoadingIndicator = function LoadingIndicator2(_ref) {
  var innerProps = _ref.innerProps, isRtl = _ref.isRtl, _ref$size = _ref.size, size2 = _ref$size === void 0 ? 4 : _ref$size, isCompact = _ref.isCompact, xcss = _ref.xcss, restProps = _objectWithoutProperties(_ref, _excluded4);
...
var MultiValueContainer = function MultiValueContainer2(_ref) {
  var children = _ref.children, innerProps = _ref.innerProps, isFocused = _ref.isFocused, isDisabled = _ref.isDisabled, className = _ref.className, xcss = _ref.xcss;
...
function DummyInput(_ref) {
  var innerRef = _ref.innerRef, props = _objectWithoutProperties(_ref, _excluded7);
...
var RequiredInput = function RequiredInput2(_ref) {
...
function useAsync(_ref) {
  var _ref$defaultOptions = _ref.defaultOptions, propsDefaultOptions = _ref$defaultOptions === void 0 ? false : _ref$defaultOptions, _ref$cacheOptions = _ref.cacheOptions, cacheOptions = _ref$cacheOptions === void 0 ? false : _ref$cacheOptions, propsLoadOptions = _ref.loadOptions, propsOptions = _ref.options, _ref$isLoading = _ref.isLoading, propsIsLoading = _ref$isLoading === void 0 ? false : _ref$isLoading, propsOnInputChange = _ref.onInputChange, _ref$filterOption = _ref.filterOption, filterOption = _ref$filterOption === void 0 ? null : _ref$filterOption, restSelectProps = _objectWithoutProperties(_ref, _excluded8);
  var propsInputValue = restSelectProps.inputValue;
  var lastRequest = (0, import_react20.useRef)(void 0);
  var mounted = (0, import_react20.useRef)(false);
  var _useState = (0, import_react20.useState)(Array.isArray(propsDefaultOptions) ? propsDefaultOptions : void 0), _useState2 = _slicedToArray(_useState, 2), defaultOptions = _useState2[0], setDefaultOptions = _useState2[1];
...
function useCreatable(_ref) {
  var _ref$allowCreateWhile = _ref.allowCreateWhileLoading, allowCreateWhileLoading = _ref$allowCreateWhile === void 0 ? false : _ref$allowCreateWhile, _ref$createOptionPosi = _ref.createOptionPosition, createOptionPosition = _ref$createOptionPosi === void 0 ? "last" : _ref$createOptionPosi, _ref$formatCreateLabe = _ref.formatCreateLabel, formatCreateLabel2 = _ref$formatCreateLabe === void 0 ? builtins.formatCreateLabel : _ref$formatCreateLabe, _ref$isValidNewOption = _ref.isValidNewOption, isValidNewOption2 = _ref$isValidNewOption === void 0 ? builtins.isValidNewOption : _ref$isValidNewOption, _ref$getNewOptionData = _ref.getNewOptionData, getNewOptionData2 = _ref$getNewOptionData === void 0 ? builtins.getNewOptionData : _ref$getNewOptionData, onCreateOption = _ref.onCreateOption, _ref$options = _ref.options, propsOptions = _ref$options === void 0 ? [] : _ref$options, propsOnChange = _ref.onChange, restSelectProps = _objectWithoutProperties(_ref, _excluded9);
...
var getPrimaryColor = function getPrimaryColor2(_ref) {
  var isActive = _ref.isActive, isDisabled = _ref.isDisabled, isFocused = _ref.isFocused, isSelected = _ref.isSelected;
  if (isDisabled) {
...
var ControlOption = function ControlOption2(props) {
  var _useState = (0, import_react24.useState)(false), _useState2 = _slicedToArray(_useState, 2), isActive = _useState2[0], setIsActive = _useState2[1];
  var onMouseDown = (0, import_react24.useCallback)(function() {
    return setIsActive(true);
  }, []);
  var onMouseUp = (0, import_react24.useCallback)(function() {
  ...
  var classNames2 = (0, import_react24.useMemo)(function() {
    return cx2({
      option: true,
      "option--is-disabled": isDisabled,
      "option--is-focused": isFocused,
  ...
  }, innerProps), React20.createElement("div", {
  ...
  }, !!Icon ? React20.createElement(Icon, {
    label: "",
  ...
  }) : null), React20.createElement("div", {
...
var NewCheckboxIcon = function NewCheckboxIcon2(props) {
  return (
    ...
    React20.createElement(svg_default, props, React20.createElement("g", {
      fillRule: "evenodd"
...
var CheckboxOption = function CheckboxOption2(props) {
  return React20.createElement(ControlOption, _extends({
    Icon: (
...
var RadioOption = function RadioOption2(props) {
  return (
    ...
    React20.createElement(ControlOption, _extends({
      Icon: (
        // eslint-disable-next-line @atlaskit/platform/ensure-feature-flag-prefix
...
function createSelect(WrappedComponent) {
  var AtlaskitSelect = (0, import_react25.forwardRef)(function AtlaskitSelect2(props, forwardedRef) {
    ...
    var internalSelectRef = (0, import_react25.useRef)(null);
    (0, import_react25.useImperativeHandle)(forwardedRef, function() {
      return {
    ...
    return import_react25.default.createElement(WrappedComponent, _extends({
...
var AsyncCreatableSelect = (0, import_react26.forwardRef)(function(props, ref) {
  var stateManagerProps = useAsync(props);
  var creatableProps = useStateManager(stateManagerProps);
  var selectProps = useCreatable(creatableProps);
  return import_react26.default.createElement(Select, _extends({
    ref
  }, selectProps));
});
...
var CheckboxSelectInternal = function CheckboxSelectInternal2(_ref) {
  var components2 = _ref.components, props = _objectWithoutProperties(_ref, _excluded11);
  var mergedComponents = (0, import_react27.useMemo)(function() {
    return _objectSpread13(_objectSpread13({}, components2), {}, {
      Option: CheckboxOption
    });
  }, [components2]);
  return import_react27.default.createElement(Select_default, _extends({
...
var CheckboxSelect = import_react27.default.memo(
...
// node_modules/@atlaskit/select/dist/esm/CountrySelect.js
var Opt = function Opt2(_ref) {
  var children = _ref.children, icon = _ref.icon;
...
var controlLabel = function controlLabel2(opt) {
  return React24.createElement(Opt, {
    icon: opt.icon
...
var CountrySelect = function CountrySelect2(props) {
  ...
  return React24.createElement(Select_default, _extends({
    isClearable: false,
    formatOptionLabel,
...
var RadioSelect = import_react28.default.memo(function(_ref) {
  var components2 = _ref.components, props = _objectWithoutProperties(_ref, _excluded12);
  var mergedComponents = (0, import_react28.useMemo)(function() {
    return _objectSpread14(_objectSpread14({}, components2), {}, {
      Option: RadioOption
    });
  }, [components2]);
  return import_react28.default.createElement(Select_default, _extends({}, props, {
    isMulti: false,
    components: mergedComponents
  }));
});
...
var MenuDialog = (0, import_react29.forwardRef)(function(_ref, ref) {
  var children = _ref.children, id = _ref.id, style = _ref.style, testId = _ref.testId;
...
var DropdownIndicator3 = function DropdownIndicator4() {
  ...
  }, React26.createElement(import_search_editor_search.default, {
    color: "currentColor",
    label: ""
  }));
};
var Control3 = function Control4(_ref2) {
  ...
  }, React26.createElement(components.Control, _extends({}, props, {
    innerProps
  })));
};
var DummyControl = function DummyControl2(props) {
  return React26.createElement(visually_hidden_default, null, React26.createElement(components.Control, props));
};
var Menu3 = function Menu4(_ref3) {
  var children = _ref3.children, innerProps = _ref3.innerProps;
  return React26.createElement("div", innerProps, children);
};
var ClearIndicator3 = function ClearIndicator4(props) {
  return React26.createElement(components.ClearIndicator, props);
};
var MultiValueRemove2 = function MultiValueRemove3(props) {
  return (
    // eslint-disable-next-line @repo/internal/react/no-unsafe-spread-props
    React26.createElement(components.MultiValueRemove, props)
  );
};
...
function NotifyOpenLayerObserver2(_ref) {
  var isOpen = _ref.isOpen, onClose = _ref.onClose;
  useNotifyOpenLayerObserver({
    isOpen,
    onClose
...
var PopupSelect = function(_PureComponent) {
  function PopupSelect2() {
    ...
    _defineProperty(_this, "renderSelect", function(id) {
      ...
      var popper = import_react30.default.createElement(Popper, _extends({}, mergedPopperProps, {
        ...
        return import_react30.default.createElement(
          ...
          import_react30.default.createElement(es2015_default, {
            disabled: !focusLockEnabled,
            returnFocus: true
          }, import_react30.default.createElement(Select_default, _extends({
            label: getLabel(),
  ...
  return _createClass(PopupSelect2, [{
    ...
    value: function render() {
      ...
      return import_react30.default.createElement(Manager, null, import_react30.default.createElement(IdProvider, {
        postfix: "-popup-select"
      }, function(_ref3) {
        var id = _ref3.id;
        return import_react30.default.createElement(import_react30.default.Fragment, null, import_react30.default.createElement(Reference, null, function(_ref4) {
          var ref = _ref4.ref;
      ...
      }), import_react30.default.createElement(NotifyOpenLayerObserver2, {

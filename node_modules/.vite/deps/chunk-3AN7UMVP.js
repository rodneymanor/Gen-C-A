...
var Box = (0, import_react5.forwardRef)(
  function(_ref, ref) {
    ...
    if (backgroundColor) {
      return React6.createElement(SurfaceContext.Provider, {
...
var Flex = (0, import_react9.memo)((0, import_react9.forwardRef)(function(_ref, ref) {
...
var Inline = (0, import_react10.memo)((0, import_react10.forwardRef)(function(_ref2, ref) {
  ...
  var children = separatorComponent ? import_react10.Children.toArray(rawChildren).filter(Boolean).map(function(child, index) {
    return React9.createElement(import_react10.Fragment, {
      key: index
...
var Stack = (0, import_react11.memo)((0, import_react11.forwardRef)(function(_ref, ref) {
  ...
  return React10.createElement(flex_default, _extends({}, ariaAttributes, {
    as,
    role,
    gap: space,
    direction: "column",
    ...
    xcss: cx2(grow === "hug" && styles3.hug, grow === "fill" && styles3.fill, xcss),
    testId,
    ref
  }), children);
}));
...
var HasTextAncestorContext = (0, import_react12.createContext)(false);
var useHasTextAncestor = function useHasTextAncestor2() {
  return (0, import_react12.useContext)(HasTextAncestorContext);
};
...
var Text = (0, import_react13.forwardRef)(function(_ref, ref) {
  ...
  var component = React11.createElement(Component2, {
    id,
    className: ax([styles4.root, size && fontSizeMap[size], color && textColorMap[color], maxLines && styles4.truncation, maxLines === 1 && styles4.breakAll, align && styles4["textAlign.".concat(align)], weight && fontWeightMap[weight], Component2 === "em" && styles4["as.em"], Component2 === "strong" && styles4["as.strong"], xcss]),
    style: {
  ...
  return React11.createElement(HasTextAncestorProvider, {
    value: true
  }, component);
});
...
var Focusable = (0, import_react14.forwardRef)(function(_ref, ref) {
  var _ref$as = _ref.as, Component2 = _ref$as === void 0 ? "button" : _ref$as, children = _ref.children, isInset = _ref.isInset, testId = _ref.testId, style = _ref.style, xcss = _ref.xcss, htmlAttributes = _objectWithoutProperties(_ref, _excluded6);
  var _spreadClass = htmlAttributes.className, safeHtmlAttributes = _objectWithoutProperties(htmlAttributes, _excluded22);
  return React12.createElement(Component2, _extends({}, safeHtmlAttributes, {
...
var Pressable = (0, import_react15.forwardRef)(function(_ref, ref) {
  ...
  var handleClick = (0, import_react15.useCallback)(function(e, analyticsEvent) {
  ...
  return React13.createElement(
    ...
    _extends({
      ...
      onClick,
      disabled: isDisabled,
      xcss: cx(styles5.root, isDisabled && styles5.disabled, xcss),
      testId,
      ref
    }),
    children
...
var RouterLinkProviderContext = (0, import_react17.createContext)({});
...
var ColorModeContext = (0, import_react18.createContext)(void 0);
var SetColorModeContext = (0, import_react18.createContext)(void 0);
var ThemeContext = (0, import_react18.createContext)(void 0);
var SetThemeContext = (0, import_react18.createContext)(void 0);
...
// node_modules/@atlaskit/app-provider/dist/esm/app-provider.js
var InsideAppProviderContext = (0, import_react19.createContext)(false);
...
var useRouterLink = function useRouterLink2() {
  var _useContext = (0, import_react20.useContext)(RouterLinkProviderContext), routerLinkComponent = _useContext.routerLinkComponent;
...
var AnchorNoRef = function AnchorNoRef2(_ref, ref) {
  ...
  return React17.createElement(
    ...
    _extends({
      ...
      xcss: cx(styles6.root, styles6.position, xcss),
      testId,
      "data-is-router-link": testId ? isRouterLink ? "true" : "false" : void 0
    }),
    children,
    target === "_blank" && (children && !ariaLabel && !ariaLabelledBy || ariaLabelledBy) && React17.createElement(visually_hidden_default, {
...
var Grid = (0, import_react23.memo)((0, import_react23.forwardRef)(function(_ref, ref) {
...
var Bleed = import_react24.default.memo(function(_ref) {
  ...
  return import_react24.default.createElement("div", {
    className: ax([styles7.root, all && styles7["inline.".concat(all)], inline && styles7["inline.".concat(inline)], all && styles7["block.".concat(all)], block && styles7["block.".concat(block)], xcss]),
    "data-testid": testId
  }, children);
});
...
var MetricText = (0, import_react25.forwardRef)(function(_ref, ref) {
  ...
  var component = React20.createElement(Component2, {
    ref,
    "data-testid": testId,
    id,
    className: ax([styles8.root, size && fontSizeMap2[size], align && styles8["textAlign.".concat(align)]])
  }, children);
  return component;
});
...
var UNSAFE_useMediaQuery = function UNSAFE_useMediaQuery2(queryString, listener) {
  var listenerRef = (0, import_react26.useRef)(listener);
  ...
  (0, import_react26.useLayoutEffect)(
    function() {
      ...
      return (0, import_bind_event_listener2.bind)(mq, {
        type: "change",
...
//# sourceMappingURL=chunk-3AN7UMVP.js.map

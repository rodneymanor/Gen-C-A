...
import OfficeIcon from '@atlaskit/icon/glyph/office-building';
...
/**
 * Get platform-specific icon component for React
 */
export const getPlatformIconComponent = (platform: string): React.ReactNode => {
  const platformIcons: Record<string, React.ReactNode> = {
    'tiktok': <MobileIcon label="" />,
    'instagram': <ImageIcon label="" />, 
    'youtube': <VideoIcon label="" />,
    'twitter': <PersonIcon label="" />,
    'linkedin': <OfficeIcon label="" />,
    'facebook': <PeopleIcon label="" />,
    'other': <WorldIcon label="" />,
  };
 ...
 */
export const getContentTypeIcon = (type: string): React.ReactNode => {
  const typeIcons: Record<string, React.ReactNode> = {
    'video': <VideoIcon label="" />,
    'script': <EditIcon label="" />,
    'image': <ImageIcon label="" />,
    'note': <DocumentIcon label="" />,
    'idea': <LightbulbIcon label="" />,
    'audio': <AudioIcon label="" />,
    'collection': <FolderIcon label="" />,
  };
  
  return typeIcons[type.toLowerCase()] || <DocumentIcon label="" />;
};
